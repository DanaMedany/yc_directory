...
// Query: *[_type == 'startup' && defined(slug.current)] | order(__createdAt desc) {  _id,   title,   image,   category,   _createdAt ,  slug,   views,  description,   author -> {_id, name, image, bio}  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    "*[_type == 'startup' && defined(slug.current)] | order(__createdAt desc) {\n  _id, \n  title, \n  image, \n  category, \n  _createdAt ,\n  slug, \n  views,\n  description, \n  author -> {_id, name, image, bio}\n  \n}": STARTUP_QUERYResult;
  }
}
